...
ifeval::["{language}" == "DE"]
:curriculum-name: Green Software - Entwicklung ressourceneffizienter Anwendungen
:curriculum-header-title: iSAQB-Curriculum für Advanced Level: {curriculum-short}
endif::[]

ifeval::["{language}" == "EN"]
:curriculum-name: Green Software - Development of resource-efficient applications
