...
== Current Release Candidate v2024.1
...
image:https://img.shields.io/github/commits-since/isaqb-org/curriculum-green/latest.svg[]
|===
| Version | HTML | PDF
...
== Changes
- link:https://github.com/isaqb-org/curriculum-green/blob/main/CHANGELOG.md[CHANGELOG.md on GitHub]
