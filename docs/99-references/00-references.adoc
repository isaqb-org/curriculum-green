...
- [[[patterson, Patterson et al. 2011]]] David Patterson, Joseph Gonzalez, Quoc Le, Chen Liang, Lluis-Miquel Munguia, Daniel Rothchild, David So, Maud Texier, Jeff Dean: Carbon Emissions and Large Neural Network Training

**S**

- [[[sci, SCI]]] Software Carbon Intensity, https://sci-guide.greensoftware.foundation/

- [[[strubell, Strubell et al. 2019]]] Emma Strubell, Ananya Ganesh, Andrew McCallum: Energy and Policy Considerations for Deep Learning in NLP
